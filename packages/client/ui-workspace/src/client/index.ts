...
export type {
  ...
  SessionMenuItemOwnerProps, WorkspaceBrowserInjected, WorkspaceBrowserProps, WorkspacePickerInjected, WorkspacePickerProps,
  ...
  ctx.slots.inject('sidebar.workspaces', () => ctx.slots.register(
    {
      ...
      children: {
        ...
        'sidebar.workspaces.sessionMenuItem': { kind: 'list', scope: 'root' },
      },
